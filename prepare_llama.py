import pandas as pd
import os
root="data/eval/0619_16k/outputs/._models_R1-Llama3-8B/2025-06-20T13-17-46.486713"
model_name="llama3"
...
df["predictions"] = df["predictions"].apply(lambda x: "<think>\n" + ast.literal_eval(x)[0]) # ! template has "<think>\n"
...
df["full_prompt"] = df["full_prompt"].apply(lambda x: x.replace("<think>\n", ""))
