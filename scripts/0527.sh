...
{
set -e
CUDA_VISIBLE_DEVICES="2" python src/infer.py data/eval/$NAME ./models/I-Llama3-8B --use_chat_template > data/eval/$NAME/logs/I-Llama3-8B.log 2>&1
python src/metric.py data/eval/$NAME ./models/I-Llama3-8B latest >> data/eval/$NAME/logs/I-Llama3-8B.log
} &

# {
# set -e
# CUDA_VISIBLE_DEVICES="3" python src/infer.py data/eval/$NAME ./models/I-Qwen2.5-14B --use_chat_template > data/eval/$NAME/logs/I-Qwen2.5-14B.log 2>&1
# python src/metric.py data/eval/$NAME ./models/I-Qwen2.5-14B latest >> data/eval/$NAME/logs/I-Qwen2.5-14B.log
# } &
